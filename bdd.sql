...
--
-- Hôte : localhost:8889
-- Généré le :  jeu. 05 juil. 2018 à 23:16
...
--
ALTER TABLE `product`
  MODIFY `id_drone` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
