...
(11, 4, 'Drone Star Wars Tie Advanced X1', 169, '/D2D/products_pictures/StarWars.jpg', 'Rejoignez le côté obscur de la force et pilotez le chasseur de Dark Vador. Affrontez des amis avec le drone X1, lancez -vous dans des figures aériennes et des combats épiques pour repousser l\'Alliance rebelle.\r\n\r\nÉquipé d’un gyroscope 6 axis, ce drone Star Wars est d’une stabilité incroyable. Il intègre de nombreux capteurs pour vous faire revivre les plus grands moments de cette saga spatiale aux commandes d\'un drone collector.', '8', 2300, 'aucune', 40, 'sta169'),
